...
const TrustedBySection = () => {
  const logos = [
    ...
    { logo: 'https://www.vectorlogo.zone/logos/x/x-ar21.svg' }, // Replaced Twitter with X logo
    ...
    { logo: 'https://www.vectorlogo.zone/logos/linkedin/linkedin-ar21.svg' }, // Replaced Samsung with LinkedIn
